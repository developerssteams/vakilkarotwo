    ...
    <div>
      <footer className="footer-wrapper bg-dark">
        ...
        <div className="container">
          <div className="row align-items-center g-4">
            <div className="col-12">
              <div
                className="footer-logo text-center wow fadeInUp"
                data-wow-duration="1000ms"
                data-wow-delay="600ms"
              >
                <Link to="#" className="d-block">
                  <img src="assets/img/core-img/vakilkaro.png" alt="" style={{ width: "30%" }} />
                </Link>
              </div>
            </div>
            ...
            <div className="col-12 col-sm-6 col-lg-3">
              <div
                className="footer-contact-card d-flex align-items-center gap-3 wow fadeInUp"
                data-wow-duration="1000ms"
              ...
              >
                <div>
                  ...
                  >
                    <g clipPath="url(#clip0_1_603)">
                      ...
                      >
                        <path
                          d="M0 7.62939e-06H60V60H0V7.62939e-06Z"
                          fill="white"
                        />
                      </mask>
                      <g mask="url(#mask0_1_603)">
                        <path
                          d="M34.1523 1.18332C47.759 1.18332 58.8285 12.2529 58.8285 25.8594"
                          stroke="#E8BF96"
                          strokeWidth="2.34375"
                          strokeMiterlimit="10"
                          strokeLinecap="round"
                        ...
                        />
                        <path
                          d="M34.1523 8.2332C43.8708 8.2332 51.7785 16.141 51.7785 25.8594"
                          stroke="#E8BF96"
                          strokeWidth="2.34375"
                          strokeMiterlimit="10"
                          strokeLinecap="round"
                        ...
                        />
                        <path
                          d="M34.1523 15.2845C39.9837 15.2845 44.7273 20.0281 44.7273 25.8594"
                          stroke="#E8BF96"
                          strokeWidth="2.34375"
                          strokeMiterlimit="10"
                          strokeLinecap="round"
                        ...
                        />
                        <path
                          d="M34.1523 22.3344C36.0988 22.3344 37.6773 23.913 37.6773 25.8594"
                          stroke="#E8BF96"
                          strokeWidth="2.34375"
                          strokeMiterlimit="10"
                          strokeLinecap="round"
                ...
                <div>
                  ...
                  <p className="mb-0 text-white">+91 9828123489</p>
                </div>
              </div>
            </div>
            ...
            <div className="col-12 col-sm-6 col-lg-3">
              ...
              >
                <div>
                  ...
                  >
                    ...
                    <g mask="url(#mask0_1_641)">
                      <path
                        d="M5.64258 57.4062L21.0052 42.0437"
                        stroke="#E8BF96"
                        strokeWidth="2.34375"
                        strokeMiterlimit="10"
                        strokeLinecap="round"
                      ...
                      />
                      <path
                        d="M54.3562 57.4062L38.8164 41.8665"
                        stroke="#E8BF96"
                        strokeWidth="2.34375"
                        strokeMiterlimit="10"
                        strokeLinecap="round"
                      ...
                      />
                      <path
                        d="M35.2733 58.8281H50.9168C53.6033 58.8281 55.7811 56.6503 55.7811 53.9638V26.7914C55.7811 25.5019 55.269 24.265 54.3574 23.3529L50.1468 19.1402"
                        stroke="#E8BF96"
                        strokeWidth="2.34375"
                        strokeMiterlimit="10"
                        strokeLinecap="round"
                ...
                <div>
                  ...
                  <p className="mb-0 text-white">help@vakilkaro.co.in</p>
                </div>
              </div>
            </div>
            ...
            <div className="col-12 col-sm-6 col-lg-3">
              ...
              >
                  ...
                  >
                    <g clipPath="url(#clip0_1_667)">
                      ...
                      <g mask="url(#mask0_1_667)">
                        <path
                          d="M53.9155 13.8938C61.4844 25.1053 60.3068 40.4626 50.3846 50.3847C39.1268 61.6426 20.8736 61.6426 9.61559 50.3847C-1.64237 39.1268 -1.64237 20.8735 9.61559 9.61556C19.6613 -0.429985 35.2778 -1.51221 46.5224 6.37146"
                          stroke="#E8BF96"
                          strokeWidth="2.34375"
                          strokeMiterlimit="10"
                          strokeLinecap="round"
                        ...
                        />
                        <path
                          d="M30.0002 53.2617C17.1737 53.2617 6.73853 42.8265 6.73853 30C6.73853 17.1735 17.1737 6.73828 30.0002 6.73828C42.8269 6.73828 53.262 17.1735 53.262 30C53.262 42.8265 42.8269 53.2617 30.0002 53.2617Z"
                          stroke="#E8BF96"
                          strokeWidth="2.34375"
                          strokeMiterlimit="10"
                          strokeLinecap="round"
                        ...
                        />
                        <path
                          d="M32.9299 30C32.9299 31.618 31.6184 32.9297 30.0002 32.9297C28.3822 32.9297 27.0706 31.618 27.0706 30C27.0706 28.382 28.3822 27.0703 30.0002 27.0703C31.6184 27.0703 32.9299 28.382 32.9299 30Z"
                          stroke="#E8BF96"
                          strokeWidth="2.34375"
                          strokeMiterlimit="10"
                          strokeLinecap="round"
                        ...
                        />
                        <path
                          d="M32.0725 32.0714L36.6302 36.6289"
                          stroke="#E8BF96"
                          strokeWidth="2.34375"
                          strokeMiterlimit="10"
                          strokeLinecap="round"
                        ...
                        />
                        <path
                          d="M20.7424 13.9643L21.3359 14.9922"
                          stroke="#E8BF96"
                          strokeWidth="2.34375"
                          strokeMiterlimit="10"
                          strokeLinecap="round"
                        ...
                        />
                        <path
                          d="M13.967 20.7425L14.9949 21.3359"
                          stroke="#E8BF96"
                          strokeWidth="2.34375"
                          strokeMiterlimit="10"
                          strokeLinecap="round"
                        ...
                        />
                        <path
                          d="M13.967 39.2578L14.9949 38.6645"
                          stroke="#E8BF96"
                          strokeWidth="2.34375"
                          strokeMiterlimit="10"
                          strokeLinecap="round"
                        ...
                        />
                        <path
                          d="M20.7424 46.0352L21.3359 45.0073"
                          stroke="#E8BF96"
                          strokeWidth="2.34375"
                          strokeMiterlimit="10"
                          strokeLinecap="round"
                        ...
                        />
                        <path
                          d="M39.2576 46.0352L38.6643 45.0073"
                          stroke="#E8BF96"
                          strokeWidth="2.34375"
                          strokeMiterlimit="10"
                          strokeLinecap="round"
                        ...
                        />
                        <path
                          d="M46.034 39.2578L45.0061 38.6645"
                          stroke="#E8BF96"
                          strokeWidth="2.34375"
                          strokeMiterlimit="10"
                          strokeLinecap="round"
                        ...
                        />
                        <path
                          d="M46.034 20.7425L45.0061 21.3359"
                          stroke="#E8BF96"
                          strokeWidth="2.34375"
                          strokeMiterlimit="10"
                          strokeLinecap="round"
                        ...
                        />
                        <path
                          d="M39.2576 13.9643L38.6643 14.9922"
                          stroke="#E8BF96"
                          strokeWidth="2.34375"
                          strokeMiterlimit="10"
                          strokeLinecap="round"
                        ...
                        />
                        <path
                          d="M51.3428 9.009C51.8001 9.46627 51.8001 10.2076 51.3428 10.6649C50.8857 11.1221 50.1441 11.1221 49.6869 10.6649C49.2297 10.2076 49.2297 9.46627 49.6869 9.009C50.1441 8.55174 50.8857 8.55174 51.3428 9.009Z"
                          fill="#E8BF96"
                        />
                      </g>
                    </g>
                ...
                <div>
                  <p className="text-white mb-0">Working Hours:</p>
                  <p className="mb-0 text-white">Mon-Fri: 8am - 4pm</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="footer-bottom-content">
          <div className="container">
            <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between gap-4">
              {/* Copyright */}
              <p className="mb-0 copyright">
                <span id="year"></span> <Link to="#">Nano Theme</Link> All Rights
                Reserved.
              </p>
